...
let $form, $username, $password, $password2, $email, $submit, $passwordWarning, $passwordFeedback,
    $passwordQualityProgressBar, $passwordQualityProgressBarContainer, $progressLabel, $passwordSuggestionsLabel,
    $errorMessage;
